...
const RESPONSES: Record<string, string> = {
  ...
  pricing:
    "Our plans start at $997/mo for Starter, $2,497/mo for Growth, and custom Enterprise solutions. Would you like to book a free demo?",
  demo: "Great! I can schedule a demo for you. Just share your business name and we'll set up a personalized walkthrough.",
};
