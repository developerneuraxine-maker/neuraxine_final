...
export function MagneticButton({
  ...
  const variants = {
    primary:
      "bg-neon text-black hover:shadow-[0_0_30px_rgba(198,255,0,0.4)] hover:scale-105",
    secondary:
      "border border-neon/40 text-neon bg-neon/5 hover:bg-neon/10 hover:border-neon/60 hover:shadow-[0_0_20px_rgba(198,255,0,0.2)]",
